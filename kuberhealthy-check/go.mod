module github.com/hmcts/azure-cftapps-monitoring
...
require (
	github.com/Comcast/kuberhealthy/v2 v2.7.1
...
require (
	...
	github.com/aws/aws-sdk-go v1.25.24 // indirect
